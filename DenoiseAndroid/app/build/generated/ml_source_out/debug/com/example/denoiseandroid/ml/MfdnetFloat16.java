package com.example.denoiseandroid.ml;
...
public final class MfdnetFloat16 {
  @NonNull
  private final Model model;

  private MfdnetFloat16(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "mfdnet_float16.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static MfdnetFloat16 newInstance(@NonNull Context context) throws IOException {
    return new MfdnetFloat16(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static MfdnetFloat16 newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new MfdnetFloat16(context, options);
  }
